...
function ui() {
  ...
  function update() {
    ...
    */
    ...
    var $amount4 = calculateProprietorshipTax($amount1, $amount2).toFixed(2);
    var $amount5 = calculateIncorporationTax($amount1, $amount2, $amount3).toFixed(2);
    var $amount6 = ($amount4 - $amount5).toFixed(0);
...
var Carousel = function () {
  function Carousel(app, storage, service) {
    ...
    this.cv = new _carouselView2.default(this.app, this.storage, this.service);
    this.createCarousel();
  }
...
var CarouselView = function () {
  function CarouselView(app, storage, service) {
  ...
  _createClass(CarouselView, [{
    ...
    value: function infoHovers() {
      $('#info-hold-property-click').hover(function () {
        $('#info-hold-property-show').fadeIn();
      }, function () {
        $('#info-hold-property-show').fadeOut();
      });
      $('#info-sensitive-click').hover(function () {
        $('#info-sensitive-show').fadeIn();
      }, function () {
        $('#info-sensitive-show').fadeOut();
      });
      $('#info-operate-property-click').hover(function () {
        $('#info-operate-property-show').fadeIn();
      }, function () {
        $('#info-operate-property-show').fadeOut();
      });
      $('#info-subcontractors-click').hover(function () {
        $('#info-subcontractors-show').fadeIn();
      }, function () {
        $('#info-subcontractors-show').fadeOut();
      });
    }
  }, {
    key: 'logoAnimate',
