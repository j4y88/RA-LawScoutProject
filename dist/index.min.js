...
module.exports = __webpack_require__.p + "public/images/ui-icons_444444_256x240.png";
...
var App = function () {
    function App() {
        ...
        this.Carousel = new _carousel2.default(this, this.Storage, this.Service);
    }
...
function ui() {
  ...
  function update() {
    ...
    */
    ...
    var $amount1 = $("#slider1").slider("values", 0);
    var $amount2 = $("#slider2").slider("values", 0);
    var $amount3 = $("#slider3").slider("values", 0);
    var $amount4 = calculateProprietorshipTax($amount1, $amount2).toFixed(0);
    var $amount5 = calculateIncorporationTax($amount1, $amount2, $amount3).toFixed(0);
    var $amount6 = Math.max(0, ($amount4 - $amount5).toFixed(0));
  ...
  function calculateProprietorshipTax(aRev, aExp) {
    ...
    var taxableIncome = aIncome - cPP / 2;
  ...
  function calculateIncorporationTax(aRev, aExp, monthlyExpense) {
    var ai = aRev - aExp;
    var afterTaxSalary = monthlyExpense * 12;
    var preTaxSalary = 0;
    var cPP = 0;
    var ei = 0;
    var empEI = 0;
    var corporateTaxes = 0;
    ...
    var federalDeduction = (11635 + ei + cPP + 1178) * .15;

    var ontarioDeduction = (10171 + ei + cPP) * .0505;
    ...
    var finalPreTaxSalary = preTaxSalary - federalDeduction - ontarioDeduction;

    var corporateTaxableIncome = ai - finalPreTaxSalary - cPP * 2 - empEI;
    ...
    var totalTaxes = corporateTaxes + (finalPreTaxSalary - afterTaxSalary) + ei + empEI + cPP * 2;
...
var _carouselView = __webpack_require__(10);
...
var Carousel = function () {
  function Carousel(app, storage, service) {
    _classCallCheck(this, Carousel);

    this.app = app;
    this.storage = storage;
    this.service = service;
    this.cv = new _carouselView2.default(this.app, this.storage);
    this.createCarousel();
  }
...
var Service = function () {
  ...
  _createClass(Service, [{
    key: "compileData",
    value: function compileData(storage) {
      var session = storage.ss;
      var sessionArray = [];
    ...
    key: "makeObject",
    value: function makeObject(ssArray) {
      var editedArrayObject = {};
      for (var key in ssArray) {
    ...
    key: "makeFormModel",
    value: function makeFormModel(object) {
      var liabilityScore = 0;
      var model = new _formmodel2.default();
      ...
      switch (model.industry) {
        case "Construction":
          liabilityScore += 50;break;
        case "Educational Services":
          liabilityScore += 25;break;
    ...
    key: "makeJSONObject",
    value: function makeJSONObject(model) {
      var myJsonString = {};
    ...
    value: function sendForm(form) {
      ...
      var baseName = form.name.replace(/\s+/g, '').toLowerCase();
      var firstLetterName = baseName.substring(0, 1).toUpperCase();
      var restName = baseName.substr(1);
      var name = firstLetterName + restName;
      var savingsBase = form.savings.toFixed(0);
      var industryBase = form.industry.replace(/\s+/g, '');
      var baseurl = "https://facebook.us16.list-manage.com/subscribe/post?u=e6d0b1c96cefea3b6aa8267e2&amp;id=c1997644bd";
...
var _sliderUi = __webpack_require__(2);
...
var Storage = function () {
  ...
  _createClass(Storage, [{
    key: "createDefaultStorage",
    value: function createDefaultStorage() {
      //for prop and incorp numbers:
      var taxes = document.querySelectorAll(".slider-total-num");
      for (var i = 0, tax; tax = taxes[i++];) {
        this.ss.setItem(tax.id, 0);
        tax.addEventListener("change", this.updateStorageValueTaxSlider(tax.id, tax.value));
      }
      //for sliders:
      var elements = document.querySelectorAll("#form1 .slider-num");
      for (var _i = 0, element; element = elements[_i++];) {
      ...
      for (var _i2 = 0, _element; _element = radioButtons[_i2++];) {
        var ss = this.ss;
        var id = _element.id;
        var parentDiv = $('#' + id + '').closest('div').click({ ss: this.ss, id: id }, this.updateStorageValueRadio);
      ...
      var dropDown = document.querySelectorAll("#form1 select");
      for (var _i3 = 0, _element2; _element2 = dropDown[_i3++];) {
        this.ss.setItem(_element2.id, _element2.value);
        _element2.addEventListener("change", this.updateStorageValueSelect(_element2.id, _element2.value));
      }
      //for email stuff:
      var emailInfo = document.querySelectorAll("#emailName, #emailAddress");
      for (var _i4 = 0, field; field = emailInfo[_i4++];) {
        this.ss.setItem(field.id, "");
        field.addEventListener("change", this.updateStorageValueEmail(field.id, field.value));
      }
    }
  }, {
    key: "updateStorageValueTaxSlider",
    value: function updateStorageValueTaxSlider(key, value) {
    ...
    key: "updateStorageValueSlider",
    value: function updateStorageValueSlider(key, value) {
      //on page load check session storage and apply ".checked" class
      //to whichever switches were last selected in the session
      //function should be called from view file where value is determined
      this.ss.setItem(key, value);
    ...
    key: "updateStorageValueSelect",
    value: function updateStorageValueSelect(key, value) {
      this.ss.setItem(key, value);
    }
  }, {
    key: "updateStorageValueRadio",
    value: function updateStorageValueRadio(e) {
      var ss = e.data.ss;
      var id = e.data.id;
      if ($('#' + id + '').parents().hasClass('zSelected')) {
        ss.setItem(id, "selected");
        if (id.length == 8) {
          var idRoot = id.substring(0, 6);
          var idToggle = idRoot.concat("Yes");
          ss.setItem(idToggle, "");
        } else if (id.length == 9) {
          var _idRoot = id.substring(0, 6);
          var _idToggle = _idRoot.concat("No");
          ss.setItem(_idToggle, "");
        }
      }
    }
  }, {
    key: "updateStorageValueEmail",
    value: function updateStorageValueEmail(key, value) {
      this.ss.setItem(key, value);
    }
  }]);
...
var CarouselView = function () {
  function CarouselView(app, storage) {
  ...
  _createClass(CarouselView, [{
    ...
    key: "logoAnimate",
    value: function logoAnimate() {
      var logo = document.querySelector('#logo-animate');
      logo.addEventListener('click', this.addClickToExpandLogo, false);
    }
  }, {
    key: "addClickToExpandLogo",
    value: function addClickToExpandLogo() {
    ...
    key: "addClickToShrinkLogo",
    value: function addClickToShrinkLogo() {
      //console.log("shrinking");
      //reverse the addClickToExpandLogo steps to return logo to initial views
    }
  }, {
    key: "getButtons",
    value: function getButtons(flkty, storage, service) {
      var previousButton1 = document.querySelector('.back1');
      ...
      var previousButton2 = document.querySelector('.back2');
      ...
      var getReportButton = document.querySelector('.button--report');
...
module.exports = __webpack_require__.p + "public/images/BGimage.png";

/***/ }),
/* 14 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "public/images/White_logo.png";

/***/ }),
/* 15 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "public/images/ic_Founded_active.png";

/***/ }),
/* 16 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "public/images/scrollnum.png";

/***/ }),
/* 17 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "public/images/ui-icons_555555_256x240.png";

/***/ }),
/* 18 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "public/images/ui-icons_777620_256x240.png";

/***/ }),
/* 19 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "public/images/ui-icons_777777_256x240.png";

/***/ }),
/* 20 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "public/images/ui-icons_cc0000_256x240.png";

/***/ }),
/* 21 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "public/images/ui-icons_ffffff_256x240.png";
