...
var _carouselView = __webpack_require__(9);
...
var Carousel = function () {
  function Carousel() {
    ...
    this.cv = new _carouselView2.default();
    this.createCarousel();
  }
...
var _sliderUi = __webpack_require__(3);
...
var _jqueryValidate = __webpack_require__(2);
...
__webpack_require__(5); // import main from './js/main.js';


var indexer = __webpack_require__(4);

var app = new _App2.default();
app.init();
var slider = new _sliderUi2.default();
var validate = new _jqueryValidate2.default();
...
<<<<<<< HEAD
      ...
      for (var i = 0, element; element = dropDown[i++];) {
        element.addEventListener("change", this.updateStorageValue(element.id, element.value));
      }

      for (var _i = 0, _element; _element = elements[_i++];) {

        this.ss.setItem(_element.id, _element.value);
        _element.addEventListener("change", this.updateStorageValue(_element.id, _element.value));
      }
    }
  }, {
    key: "updateStorageValue",
    value: function updateStorageValue(key, value) {
...
=======
      ...
      var _loop = function _loop(_i, _element) {
        console.log(_element);

        var id = _element.id;
        var parentDiv = $('#' + id + '').closest('div').click(function () {
      ...
      for (var _i = 0, _element; _element = radioButtons[_i++];) {
        _loop(_i, _element);
      }

      //for dropdown industry list:
      var dropDown = document.querySelectorAll("#form1 select");
      for (var _i2 = 0, _element2; _element2 = dropDown[_i2++];) {
...
>>>>>>> jpila/master
    ...
    value: function updateStorageValueRadio(id) {
      // if (document.getElementById(key).type == 'radio'){
...
var CarouselView = function () {
  ...
  _createClass(CarouselView, [{
    ...
    key: 'getButtons',
    value: function getButtons(flkty) {
